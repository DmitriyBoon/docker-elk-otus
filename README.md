# Быстрогайд
Ставится ELK стек 5 версии нужно 2+ Gb RAM на хосте
В добавок Kafka/Zookeeper (standalone) как буфер
Настраиваем взаимодействие по схеме из лекции
...
Генерируем логи в /tmp/pg.log (настроен filebeat)

`cat pg.log > /tmp/pg.log`

Заходим в Kibana и ищем наши логи по app_name: postgres

В любой непонятной ситуации по цепочке описанной в самом начале просматриваем логи: docker-compose logs -f --tail="100" <servicename>
